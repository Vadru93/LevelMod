...
#define EXTRA_STRINGS 40000
#define MAX_PERMANENT_STRINGS 1000//0x2FF00
#define MAX_NUM_STRINGS 35000
#define OTHER2_SIZE 0x3A980
#define OLD_OTHER_SIZE 0x14000-0x44
#define HASH_SIZE 0xA4AD0
#define OLD_HASH_SIZE 0xBFF4
#define MAX_TRIGGERS (OTHER_SIZE / 0x14) + 1
#define MAX_TRIGGERS2 (OTHER2_SIZE / 0x14) + 1
