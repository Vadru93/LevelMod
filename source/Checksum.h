...
namespace Checksums
{
    enum CompileTimeChecksums//Generated at compile-time for improved performance and code readability
    {
        ...
        Angles = 0x9D2D0915,
        Kill = 0xF8D6A996,
        Invisible = 0xCB8B5900,
        Shatter = 0xEEC24148,
        Create = 0x70291F04,
        ShatterAndDie = 0x6E77719D,
        Visible = 0x854F17A6,
        GameObject = 0xEF59C100,
        LevelGeometry = 0xBF4D3536,
        LevelObject = 0xB7B3BD86,
        InNetGame = 0xA1DA6FE9,
        Cluster = 0x1A3A966B,
        TerrainType = 0x54CF8532,
        Type = 0x7321A8D6,
        TriggerScripts = 0x40F3A3C4,
        PedAI = 0xCBA10FFA,
        DEFAULT = 0x1CA1FF20,
        Value = 0xE288A7CB,
        TrickObject = 0x1645B830,
        TrickOb = 0x84B4667F,
        AbsentInNetGames = 0x68910AC6,
        NetEnabled = 0x20209C31,
        Permanent = 0x23627FD7,
        CreatedAtStart = 0x7C2552B9,
        Links = 0x2E7D5EE7,
        Waypoint = 0x4C23A77E,
        Restart = 0x1806DDF8,
        Relpos = 0x576D7DAE,
        Normal_Lerp_Speed = 0xD8120182,
        OnServer = 0xA330D16C,
        ANGULAR_VELOCITY = 0x5D44A5E7,
        MOVE_TO_POS = 0x86DCC80E,
        ORIENT = 0x90A91232,
        FUNCTION = 0x3551E9C2,
        param = 0x5B058376,
        text = 0xC4745838,
        Physics_Air_Gravity = 0xFAA40754,
        CHEAT_MOON = 0x9C8C6DF1,


        LM_Control_bRevert = 0xEFA6D47E,
        LM_Control_SpineButton = 0x2A135B22,
        //LM_Control_bNewTricks = 0x0760404D,
        LM_Control_AirTrickSpeed = 0x24A516D2,
        LM_Control_bWallplant = 0xA49CE485,
