...
void FixRenderBugs()
{
	...
	VirtualProtect((void*)0x004f4ba9, sizeof(renderjmp1), old, NULL);
...
void FixVertBugs()
{
	...
	VirtualProtect((void*)0x004A2C39, sizeof(vertjmp1), old, NULL);
	...
	VirtualProtect((void*)0x004002c8, sizeof(vertfix1), old, NULL);
	...
	VirtualProtect((void*)0x004A2C23, sizeof(vertjmp2), old, NULL);
	...
	*(float*)b = 36.0f;
	VirtualProtect((void*)b, 4, old, NULL);
