...
double Gfx::exact_high_diff = 0.008333333333333333333333333333;
double Gfx::exact_high = (1000.0 / Gfx::target_fps) + Gfx::exact_high_diff;
double Gfx::exact_low_diff = 0.066666666666666666666666666667;
double Gfx::exact_low = (1000.0 / Gfx::target_fps) - Gfx::exact_low_diff;
double Gfx::hybrid_high_diff = 0.133333333333333333333333333333;
double Gfx::hybrid_high = (1000.0 / Gfx::target_fps) + Gfx::hybrid_high_diff;
double Gfx::sleep_high_diff = 0.276666666666666666666666666667;
double Gfx::sleep_high = (1000.0 / Gfx::target_fps) - Gfx::sleep_high_diff;
double Gfx::sleep_low_diff = 1.286666666666666666666666666667;
double Gfx::sleep_low = (1000.0 / Gfx::target_fps) - Gfx::sleep_low_diff;
